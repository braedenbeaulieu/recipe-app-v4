        ...
        <div class="grid md:grid-cols-2 gap-8">
            <div>
                ...
                <ul class="flex justify-center items-center w-full mb-8">
                    <li class="text-[#1a4e48] min-w-[62px] h-[50px] flex flex-col justify-center items-center border-r px-2" >
                    ...
                    <li class="text-[#1a4e48] min-w-[62px] h-[50px] flex flex-col justify-center items-center px-2">
