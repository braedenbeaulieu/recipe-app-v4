<template>
    <div ref="container">
        <div class="grid md:grid-cols-2 gap-8 text-black">
            <div>
                <div class="object-cover rounded-2xl max-h-[340px] overflow-hidden shadow-lg">
