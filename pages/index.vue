    ...
    <div>
        ...
        <ContentList path="/recipes" v-slot="{ list }">
            <div class="grid grid-cols-2 lg:grid-cols-3 gap-4">
                <NuxtLink class="relative before:content-[''] before:rounded-md before:absolute before:inset-0 before:bg-black before:bg-opacity-20" v-for="recipe in list" :key="recipe._path" :to="recipe._path">
                    <div class="h-64">
