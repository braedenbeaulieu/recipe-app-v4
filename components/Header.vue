<template>
    <header class="max-w-[1100px] mx-auto px-4 md:px-8 py-6 flex justify-between items-center text-black">
        ...
        <div class="flex justify-center md:gap-2">
            <a href="/recipes/search" title="Search" class="p-1 sm:p-2 hover:text-[#1a4e48] rounded-md">
